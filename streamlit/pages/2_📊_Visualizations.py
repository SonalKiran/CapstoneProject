...
if st.sidebar.checkbox('Bike Rental Data'):
    ...
    # loading data
    file_path = f'streamlit/data/{target}_avg_by_station.csv'
    ...
    # loading data
    file_path_2 = f'streamlit/data/{target}.csv'
...
if st.sidebar.checkbox('Weather Data'):
    ...
    # target = st.selectbox('Choose a time frame', ['daily', 'weekly', 'monthly'])
    # loading data
    combined_data = load_combined_data('streamlit/data/combined_data.csv')
